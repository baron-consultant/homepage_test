...
with sync_playwright() as pw:
    ...
    for mode in ('limited-after',):
        for repeat in range(1,4):
            ...
            page.route('**/ko/egbim/js/interface.js*',lambda route:route.fulfill(status=200,content_type='application/javascript',body=(ROOT/'ko/egbim/js/interface.js').read_bytes()))
